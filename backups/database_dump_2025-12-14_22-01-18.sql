...
-- Generated: 2025-12-14 22:01:18.671753
-- Database: PostgreSQL
...
-- Data for derevo
INSERT INTO derevo (id, stvol, fitil) VALUES (1, 'большой', TRUE);
INSERT INTO derevo (id, stvol, fitil) VALUES (2, 'Big', TRUE);
...
INSERT INTO employee (employee_id, full_name, position, hire_date, department, phone, qualification) VALUES (7, 'Новиков Павел Александрович', 'Экскурсовод', '2023-01-15 00:00:00', 'Экскурсионный отдел', '+375292789023', 'Инженер ракетно-космическо техники');
INSERT INTO employee (employee_id, full_name, position, hire_date, department, phone, qualification) VALUES (2, 'Петрова Марья Сергеевна', 'Главный хранитель', '2012-09-01 00:00:00', 'Отдел фондов', '+375296234578', 'Кандидат искусствоведения');
INSERT INTO employee (employee_id, full_name, position, hire_date, department, phone, qualification) VALUES (21, 'Новиков Павел', 'Экспозитор', '2023-01-15 00:00:00', 'Выставочный отдел', '+72232312323', 'Инженер ракетно-космическо техники');
...
INSERT INTO exhibit (exhibit_id, title, description, creation_date, country, state, type, mission_id) VALUES (22, 'йц', 'йайуайц', '2022-02-22 00:00:00', 'США', 'На экспозиции', 'Копия', NULL);
...
INSERT INTO exhibition (exhibition_id, title, theme, start_date, end_date, location, type) VALUES (20, 'Орбитальные станции', 'Жизнь и работа на орбите', '2025-05-01 00:00:00', '2026-05-20 00:00:00', 'Зал №1', 'Постоянная');
...
-- Table: polyana
-- DROP TABLE IF EXISTS polyana CASCADE;

CREATE TABLE IF NOT EXISTS polyana (
    id INTEGER NOT NULL,
    cvet INTEGER NOT NULL DEFAULT 255,
    derevo_id INTEGER NOT NULL,
    PRIMARY KEY (id),
    FOREIGN KEY (derevo_id) REFERENCES derevo(id) ON DELETE CASCADE
);

-- Data for polyana
INSERT INTO polyana (id, cvet, derevo_id) VALUES (3, 123, 2);
INSERT INTO polyana (id, cvet, derevo_id) VALUES (1, 555, 1);
...
INSERT INTO space_mission (mission_id, title, country, start_date, end_date, crew, goal) VALUES (2, 'Аполон-11', 'США', '1969-07-16 00:00:00', '1969-07-25 00:00:00', ARRAY['Нил Армстронг', 'Базз Олдрин', 'Майкл Коллинз'], 'Первая высадка человека на Луну');
...
INSERT INTO visitor (visitor_id, full_name, birth_date, citizenship, ticket_type, visit_date, review) VALUES (21, 'Барбарис Никита Александрович', '2020-12-12 00:00:00', 'Беларусь', 'Детский', '2024-12-12 00:00:00', '');
